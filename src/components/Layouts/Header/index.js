  ...
  return (
    <header className={cx("header")}>
      <div className={cx("header-wrapper")}>
        <NavLink className={cx("header-logo")} to="/">
          <img
      ...
      {isMenuOpen && (
        <div className={cx("overlay")} conClick={() => setIsMenuOpen(false)} />
      )}
